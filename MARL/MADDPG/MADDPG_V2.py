...
"""
import numpy as np
from env2 import MultiAgentEVCharge2
import torch as T
...
if __name__  == "__main__":
  ...
  env = MultiAgentEVCharge2(num_agents = 4)
  env.reset()
  obs, infos = env.reset()
...
#     actor_dims.append(dims)
  ...
  maddppg_agents = MADDPG(actor_dims, critic_dims, n_agents, n_actions_1, n_actions_2, env,
                          alpha=0.001, beta=0.01, fc1=64, fc2=64, gamma=0.99, tau = 0.01, chkpt_dir='C:/Users/luisb/EVCHARGING/tmp/maddpg_v2')
  ...
  for i in range(N_EPS):
    ...
    if not evaluate and memory.ready() :
