...
class Agent:
  ...
  def choose_action(self, observation):
    ...
    state = T.cat((soc, target_soc, time_left_depot, available_stations), dim = -1)
...
if __name__  == "__main__":
  ...
  maddppg_agents = MADDPG(actor_dims, critic_dims, n_agents, n_actions_1, n_actions_2, env,
                          alpha=0.001, beta=0.001, fc1=64, fc2=64, gamma=0.99, tau = 0.01, chkpt_dir='C:/Users/luisb/EVCHARGING/tmp/maddpg')
